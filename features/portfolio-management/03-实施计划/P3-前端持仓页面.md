...
**Spec:** [需求规格说明](../01-需求规格/需求规格说明.md)（§三 FR-A1~A5、FR-B1/B2、FR-C1~C5）· [P2](../03-实施计划/P2-组合用例与接口.md) · [ADR-0006 前端 CopilotKit](../../../docs/technology/decisions/0006-frontend-copilotkit.md)

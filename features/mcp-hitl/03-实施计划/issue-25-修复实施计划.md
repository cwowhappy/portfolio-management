...
**Spec:** `features/mcp-hitl/02-设计规格/设计规格说明.md`（§三前端设计、§五已知限制、§七真机验收记录）；issue [#25](https://github.com/cwowhappy/portfolio-management/issues/25)。
...
**Files:**
- Modify: `features/mcp-hitl/02-设计规格/设计规格说明.md`（§七表格更新）
- Modify: `features/mcp-hitl/03-实施计划/交接事项.md`（四项结论更新）
...
```bash
git add features/mcp-hitl/02-设计规格/设计规格说明.md features/mcp-hitl/03-实施计划/交接事项.md

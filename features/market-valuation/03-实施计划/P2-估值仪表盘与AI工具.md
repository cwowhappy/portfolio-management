...
**Spec:** [需求规格说明](../01-需求规格/需求规格说明.md)（§三 FR-B1~B8、FR-C1/C2）· [ADR-0006 前端 CopilotKit](../../../docs/technology/decisions/0006-frontend-copilotkit.md) · [M06 模块文档](../../../docs/function/modules/06-市场估值仪表盘.md)

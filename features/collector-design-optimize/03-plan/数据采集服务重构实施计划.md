...
- Modify: `docs/technology/architecture/02-数据采集服务架构.md`（状态更新为「已重构为框架」）
...
`docs/technology/architecture/02-数据采集服务架构.md` 状态行改为「已重构为可扩展采集框架（见 features/collector-design-optimize）」。

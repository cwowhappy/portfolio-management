...
**Architecture:** 只读验证（读 jar 源码 / javap / 一次最小运行时 spike），不落业务代码；产物为 `03-实施计划/验证记录.md` 与对 `02-设计规格/设计规格说明.md` 的修正（如有）。

**Tech Stack:** javap / 读 `-sources.jar` / JUnit 5 spike（测试资源 `test-skills/`）

**Spec:** `features/skill-integration/02-设计规格/设计规格说明.md`（§十开放问题 5、§十一工具命名空间）、`docs/technology/research/agentscope/skill.md`
...
- Modify: `features/skill-integration/03-实施计划/验证记录.md`（§1）
...
```bash
git add features/skill-integration/03-实施计划/验证记录.md backend/src/test/resources/test-skills backend/src/test/java/com/portfolio/invest/agent/ClasspathSkillRepositoryTest.java
...
- Modify: `features/skill-integration/03-实施计划/验证记录.md`（§2）
...
```bash
git add features/skill-integration/03-实施计划/验证记录.md
...
- Modify: `features/skill-integration/03-实施计划/验证记录.md`（§3）
...
- Modify: `features/skill-integration/03-实施计划/验证记录.md`（§4）
...
**Files:**
- Modify: `features/skill-integration/03-实施计划/验证记录.md`（结论速览表）
- Modify: `features/skill-integration/02-设计规格/设计规格说明.md`（§十开放问题 5 → 结论；§十一工具命名空间如受影响则修正）
...
```bash
git add features/skill-integration/03-实施计划/验证记录.md features/skill-integration/02-设计规格/设计规格说明.md
...
```bash
grep -n "tushare_data\|wind_finance\|SkillFilter\|disableDefaultWorkspaceSkills" features/skill-integration/03-实施计划/验证记录.md
```

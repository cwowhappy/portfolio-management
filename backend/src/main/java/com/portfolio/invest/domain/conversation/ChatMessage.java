...
public final class ChatMessage {
    ...
    private ChatMessage(Long dbId, String id, ChatMessageRole role, String content, String payload, long createdAtMs) {
        this.dbId = dbId;
        this.id = id;
        this.role = role;
    ...
    public static ChatMessage create(Long dbId, String id, ChatMessageRole role, String content, String payload, long createdAtMs) {
        return new ChatMessage(dbId, id, role, content, payload, createdAtMs);
    }

    public Long dbId() { return dbId; }
    public String id() { return id; }
    public ChatMessageRole role() { return role; }

...
P0 协议勘误的**正式沉淀**在 [features/mcp-hitl/03-plan/验证记录.md](../../../../features/mcp-hitl/03-plan/验证记录.md)。本目录 `faq.md` / `agui.md`（尤其 `agui.md` 内针对 2.0.1 的版本警告块）与本项目实测结论有出入时，**以验证记录为准**（勘误自 2.0.3 起全部消解，详见验证记录 §7）。

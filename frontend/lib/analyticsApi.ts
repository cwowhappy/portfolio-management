import { z } from "zod";
import { AnalyticsNavSchema, AnalyticsOverviewSchema, AnnualReturnRowSchema, AttributionSchema, RiskStatsViewSchema, TradeStatsViewSchema } from "./schemas";
import type { AnalyticsNav, AnalyticsOverview, AnnualReturnRow, Attribution, RiskStatsView, TradeStatsView } from "./types";
import { request } from "./http";

// overview/nav/trade-stats/risk-stats/attribution 无流水时后端 204：http.request 对 204 不抛错、返回 undefined，
...
export const fetchAttribution = () => request<Attribution | undefined>("/api/analytics/attribution", "GET", undefined, AttributionSchema);
